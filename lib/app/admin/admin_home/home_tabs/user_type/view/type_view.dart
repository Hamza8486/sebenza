            ...
            child: Material(
              ...
              child: Padding(
                ...
                child: TextField(
                    ...
                    onChanged: (val) {
                      Get.put(HomeController()).getAccountData(search: val.toString());
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(
                        () {
                          return
                            homeController.isAccountLoading.value?loader():
                            homeController.accountList.isNotEmpty?
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                textAuth2(text:"Account Type :  "),

                                                textAuth(text:homeController.accountList[index].accountType),
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                GestureDetector(
                                                  onTap:(){
                                                    ...
                                                    Get.to(AddType(
                                                      data: "update",
                                                      data1: homeController.accountList[index],
                                                    ));
                                                  },
                                                  ...
                                                  onTap: (){
                                                    showAlertDialog(
                                                        ...
                                                        yesOnTap: () {
                                                          ...
                                                          ApiManger().deleteType(id:homeController.accountList[index].id.toString() );
                                                        });
                                                  },
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              homeController.accountList[index].status=="Active"?
                                              ...
                                              child: Padding(
                                                ...
                                                child: AppText(
                                                  title:homeController.accountList[index].status,
