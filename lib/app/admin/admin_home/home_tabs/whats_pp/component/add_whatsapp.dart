                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            AppText(
                              title:
                              widget.data=="update"?"Update Whatsapp":
                        ...
                        onTap:
                          widget.data=="update"?(){
                            if(validateRole(context)){
                              authController.updateUserTypeLoader(true);
                              ApiManger().updateWhatsapp(context: context,
                          ...
                          if(validateRole(context)){
                            authController.updateUserTypeLoader(true);
                            ApiManger().addWhatsappType(context: context);
