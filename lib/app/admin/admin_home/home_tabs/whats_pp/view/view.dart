...
import 'package:sebenza/app/admin/admin_home/home_tabs/user_type/component/add_type.dart';
import 'package:sebenza/app/admin/admin_home/home_tabs/whats_pp/component/add_whatsapp.dart';
            ...
            child: Material(
              ...
              child: Padding(
                ...
                child: TextField(
                    ...
                    onChanged: (val) {
                      Get.put(HomeController()).getWhatsaData(search: val.toString());
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(
                        () {
                          return
                            homeController.isWhatsappLoading.value?loader():
                            homeController.userWhatsList.isNotEmpty?
                            ...
                            ListView.builder(
                              ...
                              itemCount:homeController.userWhatsList.length,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                textAuth2(text:"Contact Name :  "),

                                                textAuth(text:homeController.userWhatsList[index].userName),
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                GestureDetector(
                                                  onTap:(){
                                                    ...
                                                    Get.to(AddWhatsapp(
                                                      data: "update",
                                                      data1: homeController.userWhatsList[index],
                                                    ));
                                                  },
                                                  ...
                                                  onTap: (){
                                                    showAlertDialog(
                                                        ...
                                                        yesOnTap: () {
                                                          ...
                                                          ApiManger().deleteWhatsapp(id:homeController.userWhatsList[index].id.toString() );
                                                        });
                                                  },
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                textAuth2(text:"Number :  "),

                                                textAuth(text:homeController.userWhatsList[index].whatsappNumber),
                                              ],
                                            ),
                                            Container(
                                              decoration:BoxDecoration(color:
                                              homeController.userWhatsList[index].status=="Active"?
                                              ...
                                              child: Padding(
                                                ...
                                                child: AppText(
                                                  title:homeController.userWhatsList[index].status,
