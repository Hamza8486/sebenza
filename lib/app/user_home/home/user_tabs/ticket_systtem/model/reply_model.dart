class ReplyUserModel {
  ...
  ReplyUserModel({this.status, this.message, this.data});

  ReplyUserModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data({this.supporttickets, this.replays, this.repliedFrom});

  Data.fromJson(Map<String, dynamic> json) {
    supporttickets = json['supporttickets'] != null
        ? new Supporttickets.fromJson(json['supporttickets'])
        : null;
    if (json['replays'] != null) {
      replays = <Replays>[];
      json['replays'].forEach((v) {
        replays!.add(new Replays.fromJson(v));
      });
    }
    repliedFrom = json['replied_from'] != null
        ? new RepliedFrom.fromJson(json['replied_from'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.supporttickets != null) {
      data['supporttickets'] = this.supporttickets!.toJson();
    }
    if (this.replays != null) {
      data['replays'] = this.replays!.map((v) => v.toJson()).toList();
    }
    if (this.repliedFrom != null) {
      data['replied_from'] = this.repliedFrom!.toJson();
    }
    return data;
  }
}
...
class Replays {
  ...
  Replays.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ticketId = json['ticket_id'];
    replay = json['replay'];
    replayatt = json['replayatt'];
    status = json['status'];
    type = json['type'];
...
class RepliedFrom {
  ...
  RepliedFrom.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    firstName = json['first_name'];
    lastName = json['last_name'];
    phone = json['phone'];
