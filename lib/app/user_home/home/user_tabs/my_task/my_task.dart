...
class MyTaskView extends StatelessWidget {
  MyTaskView({Key? key}) : super(key: key);
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(
                              () {
                            return
                              homeController.taskLoader.value?loader():
                              homeController.allTask.isNotEmpty?
                              ...
                              ListView.builder(
                                  ...
                                  itemCount:homeController.allTask.length,
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    textAuth(text:homeController.allTask[index].name),
                                                  ],
                                                ),
                                                Row(
                                                  children: [
                                                    GestureDetector(
                                                      onTap:(){
                                                        homeController.clear();
                                                        Get.to(AddTask(
                                                          data1: homeController.allTask[index],
                                                          data: "update",
                                                        ));
                                                      },
                                                      ...
                                                      onTap: (){
                                                        showAlertDialog(
                                                            ...
                                                            yesOnTap: () {
                                                              ...
                                                              ApiManger().deleteTask(id:homeController.allTask[index].id.toString() );
                                                            });
                                                      },
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    textAuth(text:homeController.allTask[index].date),
                                                  ],
                                                ),
                                                Container()
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    textAuth(text:homeController.allTask[index].time),
                                                  ],
                                                ),
                                                Container()
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  homeController.allTask[index].status=="Done"?
                                                  Colors.green:
                                                  homeController.allTask[index].status=="Pending"?
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: AppText(
                                                      title: homeController.allTask[index].status,
