            ...
            child: Material(
              ...
              child: Padding(
                ...
                child: TextField(
                    ...
                    onChanged: (val) {
                      Get.put(HomeController()).getUserData(search: val.toString());
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  textAuth2(text:"Full Name : "),
                                                  SizedBox(
                                                    width: Get.width * 0.02,
                                                  ),
                                                  textAuth(text:"${homeController.userList[index].firstName} ${homeController.userList[index].lastName}"),
                                                ],
                                              ),
                                              Row(
                                                children: [
                                                  GestureDetector(
                                                    onTap:(){
                                                      homeController.clear();
                                                      Get.to(AddUserView(data: "update",
                                                      data1:homeController.userList[index] ,
                                                      ));
                                                    },
                                                    ...
                                                    onTap: (){
                                                      showAlertDialog(
                                                          ...
                                                          yesOnTap: () {
                                                            ...
                                                            ApiManger().deleteResponse(id:homeController.userList[index].id.toString() );
                                                          });
                                                    },
                                          ...
                                          Row(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              textAuth2(text:"Email : "),
                                              SizedBox(
                                                width: Get.width * 0.02,
                                              ),
                                              textAuth(text:homeController.userList[index].email),
                                            ],
                                          ),
                                          SizedBox(height: Get.height*0.008,),
                                          Row(
                                           crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              textAuth2(text:"Phone No : "),
                                              SizedBox(
                                                width: Get.width * 0.02,
                                              ),
                                              textAuth(text:homeController.userList[index].phone),
                                            ],
                                          ),
                                          homeController.userList[index].country==null && homeController.userList[index].city==null?SizedBox.shrink():
                                          SizedBox(height: Get.height*0.008,),
                                          homeController.userList[index].country==null && homeController.userList[index].city==null?SizedBox.shrink():
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  textAuth2(text:"Country : "),
                                                  SizedBox(
                                                    width: Get.width * 0.02,
                                                  ),
                                                  textAuth(text:homeController.userList[index].country),
                                                ],
                                              ),
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  ...
                                                  textAuth(text:homeController.userList[index].city),
                                                ],
                                              ),
                                            ],
                                          ),
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: AppText(
                                                    title:
                                                    homeController.userList[index].roles!.isNotEmpty?
                                                    homeController.userList[index].roles![0].name!.isNotEmpty?
                                                    homeController.userList[index].roles![0].name.toString():
                                                    homeController.userList[index].roles![1].name.toString():
