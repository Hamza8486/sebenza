class InvoiceModel {
  ...
  InvoiceModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new InvoiceDataAll.fromJson(json['data']) : null;
  }
...
class InvoiceDataAll {
  List<Invoices>? invoices;

  InvoiceDataAll({this.invoices});

  InvoiceDataAll.fromJson(Map<String, dynamic> json) {
