class InvoiceAdminDetailModel {
  bool? status;
  String? message;
  Data? data;

  InvoiceAdminDetailModel({this.status, this.message, this.data});

  InvoiceAdminDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  AdminInvoicesDetialAll? invoices;

  Data({this.invoices});

  Data.fromJson(Map<String, dynamic> json) {
    invoices = json['invoices'] != null
        ? new AdminInvoicesDetialAll.fromJson(json['invoices'])
        : null;
  }
...
class AdminInvoicesDetialAll {
  ...
  AdminInvoicesDetialAll.fromJson(Map<String, dynamic> json) {
    id = json['id'];
