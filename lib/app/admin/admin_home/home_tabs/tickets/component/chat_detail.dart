...
class ChatDetailView extends StatefulWidget {
   ChatDetailView({Key? key,this.data,this.type}) : super(key: key);
  var data;
  var type;
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              widget.type=="Closed"?Container():
                              GestureDetector(
                                onTap: (){
                                  homeController.updateTickLoader(true);
                                  ApiManger().updateTickets(context: context,type:
                                  widget.type=="Pending"?"Answered":
                                  "Closed",id: widget.data.id.toString());
                                },
                                child: Icon(Icons.power_settings_new,color: AppColor.whiteColor.withOpacity(0.7),
                          ...
                          return
                            ...
                            GestureDetector(
                              ...
                              messageController.text.isEmpty
                                ...
                                ApiManger().sendMessage(context: context,type: "Admin",reply: messageController.text,
