class AdminOrders {
  ...
  AdminOrders({this.status, this.message, this.data});

  AdminOrders.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? new OrderMyData.fromJson(json['data']) : null;
  }
...
class OrderMyData {
  ...
  OrderMyData({this.orders});

  OrderMyData.fromJson(Map<String, dynamic> json) {
    if (json['orders'] != null) {
      orders = <Orders>[];
