                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(
                        () {
                          return
                           homeController.isUpdatesLoading.value?loader():
                               homeController.updatesList.isNotEmpty?
                            ...
                            ListView.builder(
                              ...
                              itemCount:homeController.updatesList.length,
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                textAuth(text:homeController.updatesList[index].title),
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                GestureDetector(
                                                  onTap:(){
                                                    homeController.clear();
                                                    Get.to(AddAnn(
                                                      data1: homeController.updatesList[index],
                                                      data: "update",
                                                    ));
                                                  },
                                                  ...
                                                  onTap: (){
                                                    showAlertDialog(
                                                        ...
                                                        yesOnTap: () {
                                                          ...
                                                          ApiManger().deleteUpdate(id:homeController.updatesList[index].id.toString() );
                                                        });
                                                  },
                                          ...
                                          children: [
                                                        Row(
                                                          children: [
                                                            ...
                                                            SizedBox(width: 5,),
                                                            AppText(
                                                              title: homeController.updatesList[index].totalView.toString(),
                                            ...
                                            Container(
                                              ...
                                              homeController.updatesList[index].status=="Active"?
                                              ...
                                              child: Padding(
                                                ...
                                                child: AppText(
                                                  title: homeController.updatesList[index].status,
